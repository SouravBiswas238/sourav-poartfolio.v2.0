...
const News = () => {
    return (
        <div>
            <h2 className='bg-gray-800 text-gray-100 border-b-2 border-violet-40 text-bold uppercase text-4xl p-7  mx-auto text-center' >News  </h2>

            <section className="px-5 py-10 pt-2 bg-gray-800 text-gray-100">
                <div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
                        ...
                        <div className="flex flex-col space-y-8 md:space-y-12">
                            <div className="flex flex-col space-y-2">
                                ...
                                <p className="text-xs  text-gray-400">47 minutes ago by
                                    <a rel="noopener noreferrer" href="#" className="hover:underline  text-violet-400">Leroy Jenkins</a>
                                </p>
                            </div>
                            <div className="flex flex-col space-y-2">
                                <h3 className="flex items-center space-x-2  text-gray-400">
                    ...
                    <div className="relative flex col-span-12 bg-center bg-no-repeat bg-cover  bg-gray-500 xl:col-span-6 lg:col-span-5 md:col-span-9 min-h-96 bg-[url(https://source.unsplash.com/random/239x319)]">
                        <span className="absolute px-1 pb-2 text-xs font-bold uppercase border-b-2 left-6 top-6  border-violet-400  text-gray-100">paris, france</span>
